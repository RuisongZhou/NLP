...
if __name__ == '__main__':
    ...
    parse.add_argument('--learning_rate', type=float, dest='learnrate', help='the NN learnRate', default=0.05)
    ...
    if args.wordvec_flag:
        ...
        pass
    # pdb.set_trace()
    word_ids,W_list = data_process.getWordsVect(W)
    ...
    for index in tqdm(range(10)):
        ...
        train_x, train_y, test_x, test_y = data_process.get_train_test_data2(word_ids,revs,index,sentence_max_len)
        # step3 create TextCNN model
        ...
        # step5 validation
        accur,loss = text_cnn.validation(test_x, test_y)
        #
